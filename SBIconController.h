...
@class NSMutableArray, NSTimer, SBDockIconListView, SBFolder, SBFolderSlidingView, SBFolderView, SBIcon, SBIconIndexPath, SBIconListPageControl, SBIconListView, SBIconModel, SBIconScrollView, SBLeafIcon, SBRootFolder, SBSearchController, SBSearchView, SBWallpaperNotchView, TPLCDTextView, UIKeyboard, UITouch, UIView;

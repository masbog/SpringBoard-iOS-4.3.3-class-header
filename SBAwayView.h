...
@class NSDictionary, NSTimer, SBActivationView, SBAlertImageView, SBAwayChargingView, SBAwayDateView, SBAwayInCallController, SBAwayItemsView, SBAwayLockBar, SBAwaySwipeGestureRecognizer, SBAwayViewPluginController, TPBottomButtonBar, UIAlertView, UIPushButton, UIView;

...
@class SBApplicationIcon, SBNowPlayingBarMediaControlsView, UIButton, UIImageView, UISlider;
...
@property(retain, nonatomic) SBApplicationIcon *nowPlayingIcon; // @synthesize nowPlayingIcon=_nowPlayingIcon;

...
- (id)defaultImage:(char *)arg1 preferredScale:(float)arg2 originalOrientation:(int *)arg3 currentOrientation:(int *)arg4 launchingInterfaceOrientation:(int)arg5 canUseIOSurface:(BOOL)arg6;

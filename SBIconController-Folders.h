...
- (void)dropIconIntoOpeningFolder:(id)arg1;
- (void)_moveDroppedIconsIntoFolderIconListView;
- (void)dropIconIntoOpeningFolderAnimationDidStop:(id)arg1 finished:(id)arg2 context:(void *)arg3;
...
- (unsigned int)_folderRowsForIconCount:(unsigned int)arg1;
